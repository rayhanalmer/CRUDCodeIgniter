...
<body class="d-flex flex-column h-100">
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="">FTEIC Assets</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/departemen?cari=">Departemen</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/inventory_departemen?cari=">Departemen Assets</a>
                    </li>
                </ul>                
    ...
    <footer class="footer mt-auto py-3">
        <div class="container">
            <span class="text-muted">FTEIC ITS Assets @2023</span>
        </div>
    </footer>
